    ...
    async function searchCampaign() {
        ...
        const response = await fetch(
            `http://103.23.103.43/lazismuDIY/backendLazismuDIY/public/api/campaigns?page=${currentPage}&search=${encodeURIComponent(
                searchTerm
            )}`
        );
                    ...
                    <div class="p-2">
                        ...
                        <div class="mt-4">
                            ...
                            <div class="w-full bg-gray-200 rounded-full h-2.5 mt-1">
                                <div class="bg-orange-500 h-2.5 rounded-full" style="width: ${(campaign.current_amount / campaign.target_amount) * 100}%"></div>
                            </div>
