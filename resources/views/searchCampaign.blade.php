...
<body class="font-roboto bg-gray-100 flex justify-center">
    ...
    <div class="w-[500px] bg-white min-h-screen py-4 shadow my-14">
          <button 
        ...
        <main class="container mx-auto px-4">
            ...
            <div class="flex justify-center items-center mt-6 space-x-4">
                <button id="prevPage" class="bg-orange-500 text-orange-600 px-4 py-2 rounded-lg hover:bg-orange-600 disabled:bg-gray-300 disabled:cursor-not-allowed" disabled>Prev</button>
