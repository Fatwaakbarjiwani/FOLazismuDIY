    ...
    <div class="bg-white p-8 shadow-2xl rounded-lg w-full sm:max-w-md h-screen sm:h-auto">
        ...
        <div class="mt-6 flex flex-wrap justify-center gap-4">
            ...
            <button id="downloadQrCodeWithDetails"
                class="w-full px-6 py-2 bg-blue-500 text-white rounded-lg shadow-xl hover:from-orange-300 hover:to-orange-500 transition duration-300 text-sm md:text-base transform hover:scale-105">
                Download QR Code
            </button>
        </div>
